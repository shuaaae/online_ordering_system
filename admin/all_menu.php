...
?>
        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                <ul class="navbar-nav"> <!-- Remove ml-auto for right alignment -->
...
<?php
    ...
    if (!mysqli_num_rows($query) > 0) {
        echo '<td colspan="5"><center>No Menu</center></td>'; // Adjusted colspan to match your new table structure
    } else {
        while ($rows = mysqli_fetch_array($query)) {
            echo '<tr>
                    ...
                    <td>
                        <a href="delete_menu.php?menu_del=' . $rows['d_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
